...
// * @author Steven Wu
// */
//public interface ViewEventRegistration {
//
//    /**
//     * Finds the Button in the layout
//     * @param id the id of the button
//     */
//    public void setBtnViewEventRegistrations(int id);
//
//    /**
//     * Sets the OnClickListener of the button
//     * @param l the OnClickListener to be set
//     */
//    public void setViewEventRegistrationsOnClickListener(View.OnClickListener l);
//}
//
//
